...
#**************************************************************
    def insertarAlumno(self):
        conecta=Conexion()
        conecta.conectar()
        SQL="INSERT INTO alumno(codigo,nombres,apellidos,dni,sexo,ciclo)" \
            " VALUES('"+self.codigo+"','"+self.nombre+"','"+self.apellido+"','"+self.dni+"','"+self.sexo+"',"+str(self.ciclo)+")"
        print(SQL)
...
#*************************************************************
    def mostrarAlumnos(self):
        ...
        return registros
#***************************************************************
    def actualizarAlumno(selfself,codigo):
        pass
